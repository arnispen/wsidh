...
void wsidh_sha3_256(uint8_t *out, const uint8_t *in, size_t inlen) {
    WSIDH_PROFILE_BEGIN(sha3_scope, WSIDH_PROFILE_EVENT_SHA3_256);
...
void wsidh_shake128(uint8_t *out, size_t outlen,
    ...
    WSIDH_PROFILE_BEGIN(shake_scope, WSIDH_PROFILE_EVENT_SHAKE128);
...
void wsidh_shake256(uint8_t *out, size_t outlen,
                    const uint8_t *in, size_t inlen) {
    WSIDH_PROFILE_BEGIN(shake256_scope, WSIDH_PROFILE_EVENT_SHAKE256);
